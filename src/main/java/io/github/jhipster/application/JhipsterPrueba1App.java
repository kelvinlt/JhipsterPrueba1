...
public class JhipsterPrueba1App {

    private static final Logger log = LoggerFactory.getLogger(JhipsterPrueba1App.class);

    private final Environment env;

    public JhipsterPrueba1App(Environment env) {
        this.env = env;
    }

    /**
     * Initializes JhipsterPrueba1.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterPrueba1App.class);
